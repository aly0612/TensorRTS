...
"""
NOTE This selfplay script is originally written to adhere to the version of
TensorRTS laid out in PA4, which is not identical to the version currrently
implemented as of the time that this is being uploaded. That is planned to
change, but until then, this selfplay script will not work.
"""
